...
class TestDatabase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        sql.execute_sql(self.conn, sql.sql_add_item_row(), self.item1[0], self.item1[1], self.item1[2], self.item1[3], self.item1[4], self.item1[5], self.item1[6])
        sql.execute_sql(self.conn, sql.sql_add_item_row(), self.item2[0], self.item2[1], self.item2[2], self.item2[3], self.item2[4], self.item2[5], self.item2[6])
        sql.execute_sql(self.conn, sql.sql_add_item_row(), self.item3[0], self.item3[1], self.item3[2], self.item3[3], self.item3[4], self.item3[5], self.item3[6])
        sql.execute_sql(self.conn, sql.sql_add_item_row(), self.item4[0], self.item4[1], self.item4[2], self.item4[3], self.item4[4], self.item4[5], self.item4[6])
        sql.execute_sql(self.conn, sql.sql_add_item_row(), self.item5[0], self.item5[1], self.item5[2], self.item5[3], self.item5[4], self.item5[5], self.item5[6])
        sql.execute_sql(self.conn, sql.sql_add_item_row(), self.item6[0], self.item6[1], self.item6[2], self.item6[3], self.item6[4], self.item6[5], self.item6[6])
        sql.execute_sql(self.conn, sql.sql_add_item_row(), self.item7[0], self.item7[1], self.item7[2], self.item7[3], self.item7[4], self.item7[5], self.item7[6])
