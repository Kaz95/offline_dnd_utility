...
class DashboardPage(MainWindow):
    def __init__(self, root):
        ...
        self.currency_treeview.column('copper', width=55, anchor='center')
        self.currency_treeview.heading('#0', text='Gold')
        self.currency_treeview.heading('silver', text='Silver')
        self.currency_treeview.heading('copper', text='Copper')
